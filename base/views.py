...
#from django.contrib.auth.forms import UserCreationForm #! we are using a custom user form

from django.contrib import messages #! for flash messages

from . models import Room, Topic, Message, User
from .forms import RoomForm, UserForm, MyUserCreationForm #! removed UserCreationForm and inserted this form
...
def updateUser(request):
    ...
    if request.method == 'POST':
        form = UserForm(request.POST, request.FILES, instance = user) #! request.FILES for uploading files eg profile pic
        if form.is_valid():
            form.save()
